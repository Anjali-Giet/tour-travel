<?php
  $conn=new mysqli("localhost","root","","project login page");
  $result=$conn->query("SELECT * FROM `project login page`");
   
  $Email=$_POST['Email'];
  $password=$_POST['password'];
  if(isset($_POST['submit'])){
    $res=$conn->query("INSERT INTO `project login page`(`email`, `password`) VALUES ('$Email','$password')");
  }
  // if($res){
  //   echo "success"
  ...
  $result=$con->query("SELECT * FROM `book now`");
  ...
  if(isset($_POST['submit'])){
    $res=$con->query("INSERT INTO `book now`(`whereto`, `howmany`, `arrivals`, `leaving`) VALUES ('$whereto','$howmany','$arrivals','$leaving')");
  }
  ...
  if(isset($_POST['submit'])){
    // $res=$conn->query("INSERT INTO `contact`(`name`, `email`, `number`, `subject`, `message`) VALUES ('$name','$email','$num','$sub',$message)");
    $res=$conn->query("INSERT INTO `contact`(`name`, `email`, `number`, `subject`) VALUES ('$name','$email','$num','$sub')");
  }
?>
<!DOCTYPE html>
<html lang="en">
...
<section class="contact" id="contact">
    ...
    <div class="row">
        ...
        <form method="post">
            ...
            <!-- <textarea placeholder="message" name="" id="" cols="30" rows="10" name = "message"></textarea>
            <input type="text" placeholder="message" name="" id="" cols="30" rows="10" name = "message">
